<?php 
$pageTitle = "Organisation du HADJ et OUMRA - Agence SAFIR";
include('includes/header.php'); 
?>

<section class="hero-section text-white text-center py-5" style="background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('assets/images/hadj-oumra-hero.jpg') no-repeat center center/cover;">
    <div class="container">
        <h1 class="display-3 fw-bold">HADJ et OUMRA</h1>
        <p class="fs-4 mt-3">Votre pèlerinage sacré, organisé avec dévotion et expertise.</p>
    </div>
</section>
        ...
        <div class="col-lg-10">
            <div class="card shadow-lg border-0 rounded-3 mb-4">
                <div class="card-body p-5">
                    <h2 class="card-title text-center mb-4 fw-bold">Un service complet pour votre pèlerinage</h2>
                    <p class="card-text lead text-center mb-5">L'agence SAFIR vous propose un accompagnement complet pour l'accomplissement de votre HADJ ou de votre OUMRA. Nos formules incluent :</p>
                    ...
                    <div class="text-center mt-4">
                        <a href="reservation.php?service=hadj_oumra" class="btn btn-primary btn-lg px-5 py-3 rounded-pill">Demander un devis</a>
                    </div>
                </div>
            </div>
        </div>
