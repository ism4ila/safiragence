...
@section('title', 'Créer un Encadreur - SAFIR Admin')

@section('content')
    <div class="admin-page-header">
        <div>
            <h1 class="admin-page-title">Créer un Encadreur</h1>
            <p class="admin-page-subtitle">Ajoutez un nouvel encadreur à l'équipe SAFIR</p>
        </div>
            ...
            <form action="{{ route('admin.encadreurs.store') }}" method="POST">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" name="phone_1" id="phone_1" class="form-control @error('phone_1') is-invalid @enderror" 
                                   value="{{ old('phone_1') }}" placeholder="Ex: +221 77 123 45 67" required>
                            @error('phone_1')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <textarea name="specialties" id="specialties" rows="3" 
                                      ...
                                      placeholder="Décrivez les spécialités de l'encadreur">{{ old('specialties') }}</textarea>
                            @error('specialties')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="notes" id="notes" rows="4" 
                                      ...
                                      placeholder="Notes additionnelles sur l'encadreur">{{ old('notes') }}</textarea>
                            @error('notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-check-circle me-2"></i>Créer l'Encadreur
                    </button>
                </div>
            </form>
        </div>
